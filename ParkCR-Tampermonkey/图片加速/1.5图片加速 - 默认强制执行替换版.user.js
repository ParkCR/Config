// ==UserScript==
// @name         Image URL Replacement Accelerated Version
// @namespace    http://tampermonkey.net/
// @version      1.5
// @description  在网页中将以指定前缀开头的图片URL进行替换，支持多个CDN节点选择，优化图片加载速度
...
// @grant        none
// @changelog    1.5: 修改逻辑，默认脚本加载全页面图片都使用加速链接
//               1.3: 新增CDNjson节点
//               1.2: 新增Picseed节点
//               1.1: 新增ImageCDN节点
//               1.0: 新增Flyimg节点
